...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-16 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-0 md:gap-20 md:grid-cols-2">
        <div>
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-8 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-8 w-8 items-center justify-center rounded-full bg-neutral-800"
            >
