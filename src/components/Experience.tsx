...
export default function Experience({ data }: ExperienceProps): ReactElement {
  return (
    <section className="flex flex-col bg-black text-white mt-24 py-20 px-6 sm:px-10 md:px-24 xl:px-56">
      {/* Title */}
      <h1 className="text-3xl md:text-5xl font-medium mb-20 text-center">
